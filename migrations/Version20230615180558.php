 ...
 */
final class Version20230615180558 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE command_line ADD commandID INT DEFAULT NULL, ADD productID INT DEFAULT NULL, DROP command_id, DROP product_id');
